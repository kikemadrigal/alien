...
rem start /wait tools\Disk-Manager\DISKMGR.exe -A -F -C disco.dsk obj\autoexec.BAS
rem start /wait tools\Disk-Manager\DISKMGR.exe -A -F -C disco.dsk obj\main.bin
...
rem MSX2
rem start /wait tools/emulators/openmsx/openmsx.exe -machine Philips_NMS_8255 -diska disco.dsk
